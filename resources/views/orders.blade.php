...
<head>
    ...
    <style>
        ...
        .sidebar { width: 260px; background: #ffffff; height: 100vh; position: fixed; top: 0; left: 0; z-index: 1030; display: flex; flex-direction: column; border-right: 1px solid #e2e8f0; }
        .sidebar .nav-link { color: #64748b; padding: 12px 20px; margin: 4px 16px; border-radius: 10px; font-weight: 500; transition: all 0.2s ease; }
        .sidebar .nav-link:hover { background-color: #f1f5f9; color: #0f172a; }
        .sidebar .nav-link.active { font-weight: 600; background-color: #4f46e5; color: #ffffff; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.15); }
        ...
        .badge-custom { padding: 6px 12px; border-radius: 8px; font-weight: 600; font-size: 0.75rem; letter-spacing: 0.3px; }
        .action-btn { width: 32px; height: 32px; padding: 0; display: inline-flex; align-items: center; justify-content: center; border-radius: 8px; transition: all 0.2s; }
        .item-card { transition: transform 0.2s ease, box-shadow 0.2s ease; border: 1px solid #e2e8f0; overflow: hidden; }
        .item-card:hover { transform: translateY(-3px); box-shadow: 0 10px 20px rgba(0, 0, 0, 0.04); }
        .item-img-wrapper { height: 140px; overflow: hidden; position: relative; background-color: #f1f5f9; }
        .item-img { width: 100%; height: 100%; object-fit: cover; }
        .item-category { position: absolute; top: 10px; left: 10px; font-size: 0.65rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; padding: 4px 8px; border-radius: 6px; }
        .form-label { font-weight: 600; color: #334155; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.5px; }
        .form-control, .form-select, .input-group-text { border-radius: 10px; padding: 10px 16px; border: 1px solid #cbd5e1; color: #0f172a; font-size: 0.95rem; }
        .form-control:focus, .form-select:focus { border-color: #4f46e5; box-shadow: 0 0 0 4px rgba(79, 70, 229, 0.1); }
...
<body>
                                ...
                                <div class="card item-card h-100 bg-white shadow-sm">
                                    ...
                                    <div class="card-body p-3 d-flex flex-column">
                                        ...
                                        <div class="mt-auto d-flex align-items-center justify-content-between">
                                            ...
                                            <button type="button" onclick="selectCatalogItem('Rings', 45000)" class="btn btn-sm btn-outline-primary px-2.5 py-1 rounded-3 fw-semibold style-button" style="font-size: 0.75rem; border-color: #e2e8f0; color: #4f46e5;">
                                ...
                                <div class="card item-card h-100 bg-white shadow-sm">
                                    ...
                                    <div class="card-body p-3 d-flex flex-column">
                                        ...
                                        <div class="mt-auto d-flex align-items-center justify-content-between">
                                            ...
                                            <button type="button" onclick="selectCatalogItem('Necklaces', 62000)" class="btn btn-sm btn-outline-primary px-2.5 py-1 rounded-3 fw-semibold style-button" style="font-size: 0.75rem; border-color: #e2e8f0; color: #4f46e5;">
                                                <i class="fas fa-cart-plus me-1"></i>Select
                                            </button>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function selectCatalogItem(itemName, unitPrice) {
            ...
            document.getElementById('jewelry_item').value = itemName;
