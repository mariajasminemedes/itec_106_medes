...
<div class="main-content">
    ...
    <div class="mb-5">
        <h2 class="fw-bold tracking-tight mb-1" style="color: #0f172a;">Edit Order #{{ $order->id }}</h2>
        <p class="text-muted mb-0">Modify and update existing order parameters and status tracking attributes.</p>
    </div>
    ...
    <div class="card shadow-sm border-0" style="max-width: 850px;">
        <div class="card-header bg-white py-4 px-4 border-bottom-0">
            <h5 class="m-0 fw-bold text-dark d-flex align-items-center">
                <i class="fas fa-pen-nib me-2 text-muted" style="font-size: 1.1rem;"></i>Order Modification Form
            </h5>
        </div>
            ...
            <form method="POST" action="/orders/{{ $order->id }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="customer_name" name="customer_name" value="{{ old('customer_name', $order->customer_name) }}" placeholder="Enter customer name" required>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-md-4">
                        ...
                        <input type="number" class="form-control" id="quantity" name="quantity" min="1" value="{{ old('quantity', $order->quantity) }}" oninput="calculateGrossTotal()" required>
                    </div>
                    <div class="col-12 col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="price" name="price" step="0.01" min="0" value="{{ old('price', $order->price) }}" placeholder="0.00" oninput="calculateGrossTotal()" required style="border-left: 1px solid #cbd5e1; border-top-left-radius: 0; border-bottom-left-radius: 0; padding-left: 12px;">
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                ...
                <div class="mb-5">
                    <label for="status" class="form-label">System Status Pipeline</label>
                ...
                <div class="pt-4 border-top d-flex flex-wrap gap-2">
                    <button type="submit" class="btn btn-primary px-4 py-2.5 rounded-3 fw-medium shadow-sm" style="background-color: #4f46e5; border-color: #4f46e5;">
                        <i class="fas fa-save me-2"></i>Update Order Record
                    </button>
...
<script>
    // Unified enterprise item catalogs
    const priceCatalog = {
        "Ring": 45000.00,
        "Necklace": 62000.00,
        "Bracelet": 15500.00,
        "Earrings": 28000.00,
        "Pendant": 18000.00 // Added a catalog value for the new item variant
    };

    /**
     * Updates field dynamically on catalog alteration changes
     */
    ...
    /**
     * Multiplies catalog values or manual overridden inputs accurately
     */
    ...
    // Auto-compute total configurations upon rendering document values
